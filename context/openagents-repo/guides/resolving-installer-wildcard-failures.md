...
```
**Cause**: Wildcard expansion returned context IDs that weren’t path-aligned (e.g., `standards-code` mapped to `/home/ejo4358/.config/opencode/context/core/standards/code-quality.md`). Installer treated IDs as paths.
