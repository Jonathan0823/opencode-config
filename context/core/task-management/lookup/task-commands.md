...
```bash
npx ts-node /home/ejo4358/.config/opencode/context/tasks/scripts/task-cli.ts <command> [args]
```
...
See `/home/ejo4358/.config/opencode/context/core/workflows/multi-stage-orchestration.md` for the complete workflow.
